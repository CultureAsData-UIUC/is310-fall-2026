...
Now that you understand how the web works and how GitHub Pages works, it's time to deploy your own website! You'll take the HTML page you created in the [Source & Style Assignment](../introducing-defining-cad/07-intro-html#assignment-2-styling-the-web){target="_blank"} and host it online.
...
3. Post the link to your live site in the GitHub Discussion thread [https://github.com/CultureAsData-UIUC/is310-spring-2026/discussions/4](https://github.com/CultureAsData-UIUC/is310-spring-2026/discussions/4){target="_blank"}
