...
As part of our course, we will be using GitHub's AI coding tool called Copilot. Copilot is a tool that uses machine learning to suggest code as you write. It is a bit like the auto-complete feature in Google Docs, but instead of just suggesting words, it suggests entire lines of code. You can read more about it here [https://github.com/features/copilot](https://github.com/features/copilot).
...
If for whatever reason you cannot get access, please let the instructor know and we can try and find a solution. Other tools that may be of use include ChatGPT or local/open-source tools, though some of these are more complicated to set up.
