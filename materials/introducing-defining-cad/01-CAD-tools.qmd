...
For our collective annotations, we will be using the Hypothesis platform. You can sign up for Hypothesis here [hypothes.is/signup](https://hypothes.is/signup) and join our collective group via Canvas. You will need to install the Hypothesis Browser Extension for your preferred browser as well. You should follow the instructions available in this Quick Start Guide [https://web.hypothes.is/help/quick-start-guide/](https://web.hypothes.is/help/quick-start-guide/).
...
For Firefox or Safari, you can install the Hypothesis bookmarklet by visiting the [start page](https://web.hypothes.is/start/) and following the instructions in step 2.
...
As part of our course, we will discuss how to use AI tools critically and practically while coding. GitHub Copilot is one option, and it uses machine learning to suggest code as you write. It is a bit like the auto-complete feature in Google Docs, but instead of just suggesting words, it suggests entire lines of code. You can read more about it here [https://github.com/features/copilot](https://github.com/features/copilot).
...
As a student on GitHub, you should be able to get access to Copilot through GitHub Education Benefits. You can read more about how to get access here [https://docs.github.com/en/copilot/getting-started-with-github-copilot](https://docs.github.com/en/copilot/getting-started-with-github-copilot). 
...
You can download the official installer here [https://www.python.org/downloads/macos/](https://www.python.org/downloads/macos/). You should download the latest stable version of Python 3 and use the macOS 64-bit universal installer. Once downloaded, you should open the installer and follow the instructions. You can find more detailed instructions here [https://realpython.com/installing-python/#how-to-install-from-the-official-installer](https://realpython.com/installing-python/#how-to-install-from-the-official-installer).
...
Anaconda is a free and open-source distribution of the Python and R programming languages for scientific computing, that aims to simplify package management and deployment. You can read more about it here [https://en.wikipedia.org/wiki/Anaconda_(Python_distribution)](https://en.wikipedia.org/wiki/Anaconda_%28Python_distribution%29). You can download Anaconda here [https://www.anaconda.com/download](https://www.anaconda.com/download). You should be able to use the link above to download Anaconda for Windows, Mac, and Linux.
...
Installing a separate terminal is completely optional since VS Code has built-in functionality, but in case you would like to try it out, I recommend iTerm2 [https://iterm2.com/](https://iterm2.com/) for Mac and Windows Terminal [https://aka.ms/terminal](https://aka.ms/terminal) for Windows. You should be able to use both these links to download the appropriate version for your operating system, but **please let the instructor know if you are having problems**.
...
If you decided not to install WSL and are instead using PowerShell, rather than using `oh-my-zsh` which only works on unix/linux operating systems, you can instead install `oh-my-posh`, following these instructions [https://ohmyposh.dev/docs/installation/windows](https://ohmyposh.dev/docs/installation/windows). Again this step is optional but as you can see in the image below, these types of configurations do help make your terminal more human readable.
