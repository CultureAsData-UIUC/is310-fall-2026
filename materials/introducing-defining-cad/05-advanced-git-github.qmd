...
2. **Issues**: This tab takes you to the issues page for the repository. You can read more about [GitHub Issues below](../introducing-defining-cad/05-advanced-git-github#issues).
3. **Insights**: This tab takes you to the insights page for the repository. You can read more about [GitHub Insights below](../introducing-defining-cad/05-advanced-git-github#insights).
...
7. **Topics**: This is where you can add topics to your repository. We'll discuss topics more below [GitHub Topics below](../introducing-defining-cad/05-advanced-git-github#topics).
