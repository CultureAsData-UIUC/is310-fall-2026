...
We can see a more detailed example of what this looks like from *The Proceedings of the Old Bailey*, which is one of the older Digital Humanities projects that is still in operation. The project started in 1999 and has been digitizing the records of the Old Bailey, which is the central criminal court of England and Wales. The project uses TEI to encode the text of the records, which allows them to be searched and analyzed in a variety of ways. You can read more about the project here [https://www.oldbaileyonline.org/](https://www.oldbaileyonline.org/){target="_blank"}.

What is so unique about the *Old Bailey*, as it is often called, is not just that it uses TEI and XML but also that all this markup was done by hand. Specifically, as the authors write in [the history of the project](https://www.oldbaileyonline.org/about/a-narrative-history-of-the-project#design){target="_blank"}:
...
According to the [Mozilla website](https://developer.mozilla.org/en-US/docs/Learn_web_development/Core/Structuring_content/Basic_HTML_syntax#what_is_html){target="_blank"}:
...
```powershell
New-Item -ItemType File -Name first_page.html
```
...
What we're using is called the Developer Tools Console ([you can find more info on Chrome's version here](https://developers.google.com/web/tools/chrome-devtools/console/){target="_blank"} and instructions for [Firefox here](https://developer.mozilla.org/en-US/docs/Tools/Page_Inspector/How_to/Open_the_Inspector){target="_blank"}). What we're seeing is called the **source code**.
...
Let's take a look at some of the more common HTML tags that we can use to create HTML elements [https://www.w3schools.com/tags/ref_byfunc.asp](https://www.w3schools.com/tags/ref_byfunc.asp){target="_blank"}.
...
This diagram is also from the Mozilla docs and you can read more about how HTML elements can also have [attributes here](https://developer.mozilla.org/en-US/docs/Learn_web_development/Core/Structuring_content/Basic_HTML_syntax#attributes){target="_blank"}. Some of the guidelines for using attributes are:
...
You can find a list of HTML attributes here [https://www.w3schools.com/tags/ref_attributes.asp](https://www.w3schools.com/tags/ref_attributes.asp){target="_blank"}.

```html
<h1><a target="_blank" href="https://ischool.illinois.edu/">My first page!</a></h1>
```
...
HTML is a very powerful language and there are many more tags that we can use to create HTML elements. You can find a list of all the HTML tags here [https://www.w3schools.com/tags/ref_byfunc.asp](https://www.w3schools.com/tags/ref_byfunc.asp){target="_blank"}. But HTML also has some limitations. Take a look at this helpful overview of [*HTML's shortcomings by Alison Parrish*](https://github.com/aparrish/dmep-python-intro/blob/master/scraping-html.ipynb){target="_blank"} (bold added for emphasis):
...
So far we've been either working with very simple HTML documents (like our example above). To find a middle ground, let's return to our very first week and take a look at [whatisdigitalhumanities.com](https://whatisdigitalhumanities.com/){target="_blank"}.
...
A great example of CSS in action is the [CSS Zen Garden](http://www.csszengarden.com/){target="_blank"}, which shows how the same HTML document can be styled in a variety of different ways. Another great example is this [CodePen](https://codepen.io/ste-vg/pen/GRooLza){target="_blank"} that shows how CSS can be used to create a 3D airplane (I found it via [this blog post](https://dev.to/keefdrive/top-5-most-hearted-animations-and-designs-on-codepen-whats-under-the-hood-5b0l){target="_blank"}).
...
<iframe height="300" style="width: 100%;" scrolling="no" title="Airplanes." src="https://codepen.io/ste-vg/embed/GRooLza?default-tab=result" frameborder="no" loading="lazy" allowtransparency="true" allowfullscreen="true">
  See the Pen <a target="_blank" href="https://codepen.io/ste-vg/pen/GRooLza">
  Airplanes.</a> by Steve Gardner (<a target="_blank" href="https://codepen.io/ste-vg">@ste-vg</a>)
  on <a target="_blank" href="https://codepen.io">CodePen</a>.
</iframe>
</figure>
...
If you want to learn more about what exactly this code is doing, toggle the following section. Full disclosure some of this language and concepts are fairly advanced, so feel free to use the AI tool of your choice or ask the Instructors for help:
...
Once you've completed the assignments you should push up your materials to your GitHub `is310-coding-assignments` repository. These materials should be in a new folder `source-and-style` and share the link to your folder in the GitHub discussion thread [https://github.com/CultureAsData-UIUC/is310-fall-2026/discussions/3](https://github.com/CultureAsData-UIUC/is310-fall-2026/discussions/3){target="_blank"}.

### Assignment 1: Inspecting the Cultural Web

To build from our work with digitization, digital libraries, and cultural objects, the goal is to select one digital library, archive, collection, or cultural website relevant to your area of focus and inspect the website in the browser to try and assess how it has been built (you might even see if you can find the GitHub repository for it). In your investigation, you should try and answer the following questions:
...
You can use screenshots to support your assessment, but you should also include a link to the website and the GitHub repository (if you can find it). You are also welcome to use AI tools to help you assess and investigate the web technologies. If you use AI, document the relevant prompts or conversation in an `ai-chat-log.md` file in your `source-and-style` folder. You should write your assessment in the `README.md` file in the `source-and-style` folder of your `is310-coding-assignments` repository, and remember to place any screenshots in an `images` folder (you will need to create a new one for this folder if you decide to include screenshots).

### Assignment 2: Styling the Cultural Web

For this assignment, the goal is to try creating an HTML page from scratch that presents ONE digitized cultural object related to your project interests. You should create a file called `index.html` in the `source-and-style` folder of your `is310-coding-assignments` repository. You can use the terminal to create the file or your text editor, but the file should be created in the `source-and-style` folder.
...
If you have any questions or need help, please don't hesitate to use the AI tool of your choice or reach out to the Instructors for help.
