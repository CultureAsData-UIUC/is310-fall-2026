...
For more information about built-in methods, check out the [Python documentation](https://docs.python.org/3/library/functions.html){target="_blank"}.
...
You should then put a link to our GitHub discussion [https://github.com/CultureAsData-UIUC/is310-spring-2026/discussions/5](https://github.com/CultureAsData-UIUC/is310-spring-2026/discussions/5){target="_blank"}.