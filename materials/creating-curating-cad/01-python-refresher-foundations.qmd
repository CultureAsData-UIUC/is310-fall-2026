...
If you don't see these messages, then you might not have Python installed, so return to our [setup instructions](../introducing-defining-cad/01-CAD-tools/#python) and reach out to the instructors for assistance.
