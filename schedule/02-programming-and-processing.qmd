...
- [ ] Discuss the assigned readings and answer any questions about the Introduction to [Course Tools](../materials/introducing-defining-cad/01-CAD-tools.qmd), slides available [here](../slides/02-programming-and-processing.qmd)
