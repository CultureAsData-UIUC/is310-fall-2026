...
1. **Creating culture as data:** You will transform cultural materials into a custom dataset and document the interpretive decisions that shaped that process.
2. **Auditing existing culture as data:** You will examine an existing dataset, archive, platform, API, collection, or source to understand how it already represents culture, what it makes visible, and what it leaves out.
