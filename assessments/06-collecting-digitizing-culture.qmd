...
In this week's readings, we explored the history and challenges of mass digitization, digital libraries, and data circulation. Brewster Kahle argues for universal access to knowledge through the Internet Archive, the African American Periodical Poetry dataset demonstrates the labor and choices involved in making digitized collections usable, and the Lenna Image asks what happens when a digital object should stop circulating.

Today, you will work in groups to explore digital libraries and archives through HathiTrust, the Internet Archive, Responsible Datasets in Context, and the Lenna Image. The goal is to think critically about how cultural objects become digital representations, how those representations become datasets, and when preservation or access might conflict with consent, rights, or harm.

This assignment has three components: exploring HathiTrust to understand digitization in practice, connecting that work to the African American Periodical Poetry dataset, and using Lenna to ask what it would mean for cultural data to retire. If you have questions, please reach out to the instructors on Slack.
...
1. **Finding the African American Periodical Poetry**: Using the Hennessey dataset from your readings (which is available in the [readings here](../schedule/05-histories-of-culture-and-computing.qmd#assigned-materials)), select 2-3 poems from different magazines (e.g., *The Crisis*, *Opportunity*, *Black Opals*). Try to locate the original magazine issues in HathiTrust that contain these poems.
...
6. **Data Retirement and Consent**: Now compare this example to the Lenna Image reading:

   - What makes the African American Periodical Poetry case feel like a strong example of responsible access?
   - What makes Lenna a case where continued access can become harm?
   - What would it mean for a digitized object, dataset, benchmark, or classroom example to be retired?
   - Where should decisions about access, consent, and refusal appear in metadata or documentation?
...
The final part of this assignment is to document your findings and prepare a brief synthesis for class discussion. You should create a new folder and Markdown file in your group's GitHub repository that outlines:

1. Your HathiTrust exploration findings and reflections
2. Your responses to the cultural objects prompts above
3. One connection between mass digitization, dataset documentation, and data retirement
4. One key finding, one unresolved problem, and one question your group wants to bring to class
