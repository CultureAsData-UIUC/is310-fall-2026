...
::: {.notes}
Also any new joiners to the course? If yes, please take a look at our first lesson and reach out to the Instructor on Slack. 
:::
...
::: {.notes}
Essentially, modern software is a bit of a house of cards, and it's not uncommon to spend hours trying to get something to work, only to find out that you were missing a single character in a configuration file or have some conflicting dependency. The key thing to know is that this is not a reflection of your ability to work with computers, but rather a reflection of the state of modern software. If you get stuck please ask for help!
:::
...
::: {.notes}
Use the Vincent and Li reading as the live demo because it gives us a concrete way to connect the mechanics of annotation with our discussion of data labor. The point is not polished annotation. The point is making visible where students are entering the reading.
:::
...
::: {.notes}
Have students open the data labor reading and click the Hypothesis extension icon. If they are using Firefox or Safari, remind them that they may be using the bookmarklet instead of the Chrome extension.
:::
...
::: {.notes}
After Hypothesis is activated, students should open the sidebar. This is where they can sign in, see public annotations, and switch into the course group.
:::
...
::: {.notes}
Emphasize that annotations should be made in our `is310-fall-2026` group, not publicly. The course group link is available through Canvas.
:::
...
::: {.notes}
Good annotation prompts for this reading: What labor is being made visible here? What labor is hidden? Who benefits from public code becoming training data? How does this connect to other kinds of cultural data?
:::
...
::: {.notes}
This is a low-stakes test. The goal is to make sure they can annotate a PDF or Canvas-linked reading before next Tuesday. If students have trouble with local PDFs, point them back to the course tools lesson section on annotating PDFs.
:::
...
::: {.notes}
What was your initial impression of this piece? What questions do you have?
:::
...
::: {.notes}
Why did the authors write this in 2021? Would this article look different today?

Both were PhD students under Brent Hecht at Northwestern University in The People, Space, and Algorithms (PSA) Research Group is a lab at Northwestern University. The lab focuses on identifying and addressing societal problems that are created or exacerbated by advances in computer science.

Would you consider this scholarship after our discussion on Tuesday?
:::
...
::: {.notes}
The critiques of GitHub include:

From the course tools lesson:

- GitHub centralizes a huge amount of software work.
- Public repositories can become training data for AI systems.
- The Arctic Code Vault raises questions about preservation, consent, and archival politics.
- GitHub’s contracts with ICE led to protests from parts of the developer community.
- Open sharing does not remove questions of labor, ownership, credit, or reuse.
...
How do we handle the fact taht so much of our work is mediated by platforms? How is AI changing the way we work? How do we think about the ethics of using these platforms?
:::
...
::: {.notes}
Why did the authors write this piece do you think? It was published in 2024, would it look different today? What is Knowing Machines project?
...
::: {.notes}
Use this template for your README. Take screenshots of each tool running on your computer, save them in the images folder, and reference them in your markdown file.
:::
