...
::: {.r-fit-text}
The first step is to install our required packages into our virtual environment. If you have yet to set up a virtual environment, you can follow the instructions in the [previous lesson](../materials/creating-curating-cad/04-virtual-environments){target="_blank"}.
