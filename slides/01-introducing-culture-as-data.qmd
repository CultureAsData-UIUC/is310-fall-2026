...
Some coding assignments may ask you to include an `ai-chat-log.md` file in the assignment folder. Details are available in the [AI chat log expectations](../assessments/05-github-style-guide.qmd#ai-chat-log-notes){target="_blank"}.
