...
| Component | Weight |
|-----------|--------|
| Participation and Course Community | 25% |
...
[Participation guide](../assessments/02-weekly-assessments.qmd#participation-and-course-community-25){target="_blank"}

## What Counts as Prepared?

For assigned reading days:

- Add **two Hypothesis annotations** before class
- One passage that matters
- One question, connection, or concern
...
- Complete and submit through GitHub
- Pair programming is encouraged
- You are responsible for understanding your own submission

. . .

[Coding check-ins](../assessments/02-weekly-assessments.qmd#weekly-coding-check-ins-25){target="_blank"}

## What to Submit

Each coding check-in usually includes:

- Code, notebook, webpage, or other required file
- A short `README.md` or note
- A short `ai-workflow.md` note
...
Each coding check-in should include `ai-workflow.md`.
...
- One or two useful prompts or short excerpts
- What you accepted, rejected, revised, tested, or checked
- What you still do not understand

. . .

Do **not** paste full transcripts, private data, passwords, or API keys.

[AI workflow note](../assessments/02-weekly-assessments.qmd#ai-workflow-note){target="_blank"}
...
| Mid-Semester Progress Check | Oct 20 | 15% |
...
Show concrete progress on your dataset and documentation.

. . .

This might be a manual sample, scraped/API data, an audit notebook, an HTML curation page, or another substantial artifact.

. . .

The key is explaining how your choices, sources, categories, and uncertainties are taking shape.
...
This is not only about automation. It is about understanding how computation can **augment, audit, compare, clean, publish, or question** cultural data.
...
2. **Data Structure + Cultural Choices**

. . .

3. **Computational Bridge Plan**

. . .

4. **Initial Documentation + Next Steps**
...
- Audited, expanded, or connected it computationally
- Documented how manual and computational choices shaped each other
...
|-----------|--------|
| Proposal | Pass/Fail |
| Mid-Semester Progress Check | 15% |
